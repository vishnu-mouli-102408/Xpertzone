...
interface ScheduleCallSuccessModalProps {
  isOpen: boolean;
  onClose: () => void;
  expertName: string;
  onCloseScheduleCallModal: () => void;
}

const ScheduleCallSuccessModal = ({
  isOpen,
  onClose,
  expertName,
  onCloseScheduleCallModal,
}: ScheduleCallSuccessModalProps) => {
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          <motion.p
            ...
            animate="visible"
          >
            Your call with {expertName} has been scheduled successfully. Go to
            your Call Section to see the details.
          </motion.p>
...
export default ScheduleCallSuccessModal;
