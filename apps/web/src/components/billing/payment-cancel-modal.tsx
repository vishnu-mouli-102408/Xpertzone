...
interface PaymentCancelModalProps {
  isOpen: boolean;
  onClose: () => void;
  onClosePaymentCancelModal: () => void;
}
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center">
          <motion.div
            className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-[#f94245] shadow-lg"
          ...
          <motion.p
            ...
            animate="visible"
          >
            Your payment was unsuccessful. Please check your payment details and
            try again.
          </motion.p>
