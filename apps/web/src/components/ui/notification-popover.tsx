  ...
  return (
    <div ref={notificationMenuRef} className={`relative ${textColor}`}>
      <Button
        ...
        size="icon"
        className={cn(
          "relative cursor-pointer text-gray-400 transition-all duration-300 ease-in-out hover:scale-[1.05] hover:text-white",
          buttonClassName
        )}
      >
        <Bell size={16} />
        {unreadCount > 0 && (
          <div className="absolute -right-0 -top-0 flex h-4 w-4 items-center justify-center rounded-full border border-gray-800 bg-black text-[10px] text-white">
            {unreadCount}
          </div>
        )}
      </Button>
          ...
          >
            ...
            >
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                className={`cursor-pointer text-xs transition-all duration-200 ease-in-out ${hoverBgColor} hover:text-white`}
              >
                Mark all as read
              </Button>
            </div>
