...
declare type CompilerWasmLoadingConfig = {
   ...
   */
  getRuntime: () => {
    __wbg_set_wasm(exports: unknown): unknown;
...
declare type DataLoaderOptions<T> = {
  singleLoader: (request: T) => Promise<unknown>;
  batchLoader: (request: T[]) => Promise<unknown[]>;
 ...
 * ```
 */
declare function debugCreate(namespace: string): ((
  ...args: unknown[]
) => void) & {
  color: string;
  enabled: boolean;
...
export declare type DynamicClientExtensionArgs<
  ...
  ExtArgs extends Record<string, unknown>,
> = {
...
export declare type GetPayloadResult<
  Base extends Record<unknown, unknown>,
  R extends InternalArgs["result"][string],
...
export declare function getPrismaClient(config: GetPrismaClientConfig): {
  new (optionsArg?: PrismaClientOptions): {
    ...
    _connectionPromise?: Promise<unknown> | undefined;
    _disconnectionPromise?: Promise<unknown> | undefined;
    ...
    $executeRaw(
      query: TemplateStringsArray | Sql,
      ...values: unknown[]
    ): PrismaPromise_2<unknown, unknown>;
    /**
    ...
    _transactionWithArray({
      ...
      promises: Array<PrismaPromise_2<unknown>>;
     ...
     * @returns
     */
    _request(internalParams: InternalRequestParams): Promise<unknown>;
    _executeRequest({
      args,
      clientMethod,
      dataPath,
    ...
    }: InternalRequestParams): Promise<unknown>;
...
export declare function makeTypedQueryFactory(
  sql: string
): (...values: unknown[]) => TypedSql<unknown[], unknown>;
...
export declare type MergeExtArgs<
  TypeMap extends TypeMapDef,
  ExtArgs extends Record<unknown, unknown>,
  Args extends Record<unknown, unknown>,
> = ComputeDeep<
  ExtArgs &
    Args &
...
export declare type Optional<O, K extends keyof unknown = keyof O> = {
  [P in K & keyof O]?: O[P];
} & {
...
export declare type PayloadToResult<
  P,
  O extends Record_2<unknown, unknown> = RenameAndNestPayloadKeys<P>,
> = {
  [K in keyof O]?: O[K][K] extends unknown[]
...
declare interface PrismaPromise_2<
  TResult,
  TSpec extends PrismaOperationSpec<unknown> = unknown,
...
export declare type QueryOptionsCb = (
  args: QueryOptionsCbArgs
) => Promise<unknown>;
...
declare class RequestHandler {
  ...
  mapQueryEngineResult(
    ...
    response: QueryEngineResultData<unknown>
  ): unknown;
  /**
...
export declare type Return<T> = T extends (...args: unknown[]) => infer R
  ? R
  : T;
...
export declare type SelectField<
  P extends SelectablePayloadFields<unknown, unknown>,
  K extends PropertyKey,
> = P extends {
...
export declare type ToTuple<T> = T extends unknown[] ? T : [T];
...
/** Shared */
export declare type TypeMapDef = Record<unknown, unknown>;
...
declare type Unpacker = (data: unknown) => unknown;
 ...
 */
declare type UserArgs_2 = unknown;
