...
var rs = K((zf, ts) => {
  ...
  he("no-color") || he("no-colors") || he("color=false") || he("color=never")
    ? (We = 0)
    : (he("color") || he("colors") || he("color=true") || he("color=always")) &&
      (We = 1);
  "FORCE_COLOR" in W &&
    (W.FORCE_COLOR === "true"
      ? (We = 1)
    ...
    let t = new Zn(),
      ...
      n = {
        ...
        transactionContext: async (...i) =>
          (await r(...i)).map((s) => wu(t, s)),
      };
    return (
      e.getConnectionInfo &&
        (n.getConnectionInfo = Pu(t, e.getConnectionInfo.bind(e))),
      n
    );
  },
  wu = (e, t) => {
...
var Fo = {
  enabled:
    !_o && Do == null && No !== "dumb" && ((ei != null && ei !== "0") || Lo),
};
function q(e, t) {
...
var Le = Symbol.for("@ts-pattern/matcher"),
  ...
  Pe = (e, t, r) => {
    ...
    if (oi(e)) {
      ...
      return Reflect.ownKeys(e).every((n) => {
        let i = e[n];
        return (
          (n in t || (Ur((o = i)) && o[Le]().matcherType === "optional")) &&
          Pe(i, t[n], r)
        );
        var o;
      });
  ...
  Je = (e) => {
    ...
    return oi(e)
      ? Ur(e)
        ? (t =
            (r = (n = e[Le]()).getSelectionKeys) == null
              ? void 0
              : r.call(n)) != null
          ? t
          : []
...
var Qe = (e) =>
  ...
  xe = (e) =>
    Object.assign(ge(e), {
      between: (t, r) =>
        xe(B(e, ((n, i) => k((o) => we(o) && n <= o && i >= o))(t, r))),
  ...
  Ge = (e) =>
    Object.assign(ge(e), {
      between: (t, r) =>
        Ge(B(e, ((n, i) => k((o) => Ue(o) && n <= o && i >= o))(t, r))),
...
var li = class e {
  ...
  when(t, r) {
    ...
    return new e(
      this.input,
      n ? { matched: !0, value: r(this.input, this.input) } : ai
    );
  }
  otherwise(t) {
...
function Es(e) {
  if (_c(e)) {
    ...
    return {
      dotenvResult: ys(t),
      message: _e(
        `Environment variables loaded from ${yt.default.relative(process.cwd(), e)}`
      ),
      path: e,
    };
  ...
  toString() {
    let { config: t } = this,
      r = t.provider.fromEnvVar
        ...
        : t.provider.value,
      n = JSON.parse(
        JSON.stringify({ provider: r, binaryTargets: Lc(t.binaryTargets) })
      );
...
f.inverseTangent = f.atan = function () {
  ...
  return (
    r && (s = s.times(2 << (r - 1))),
    (w = !0),
    E(s, (c.precision = p), (c.rounding = m), !0)
  );
};
f.isFinite = function () {
  return !!this.d;
...
f.minus = f.sub = function (e) {
  ...
  if (
    ((u = g.d), (m = e.d), (a = h.precision), (l = h.rounding), !u[0] || !m[0])
  ) {
    if (m[0]) e.s = -e.s;
...
f.times = f.mul = function (e) {
  ...
  return (
    ...
    (e.d = o),
    (e.e = cn(o, r)),
    w ? E(e, p.precision, p.rounding) : e
  );
};
...
f.toNearest = function (e, t) {
  ...
  return (
    e.d[0]
      ? ((w = !1), (r = $(r, e, 0, t, 1).times(e)), (w = !0), E(r))
      : ((e.s = r.s), (r = e)),
    r
  );
};
...
function Bi(e, t) {
  ...
  for (
    t == null ? ((w = !1), (l = h)) : (l = t), a = new m(0.03125);
    e.e > -2;
...
function Ke(e, t) {
  ...
  if (
    ...
    (o = y.e),
      n > 1 ? ((y = new T(`0.${r}`)), o++) : (y = new T(`${n}.${r.slice(1)}`));
  } else
    return (
...
function Cp(e) {
  var t,
    ...
    a = [];
  if (
    (e === void 0 ? (e = this.precision) : ae(e, 1, ze),
    (n = Math.ceil(e / b)),
    this.crypto)
  )
...
function Gp(
  ...
  if (u && c) {
    ...
    (s.functionName = `${m.code})`),
      (s.location = a),
      n ||
        (u = u.mapLineAt(a.lineNumber, (h) => h.slice(0, m.openingBraceIndex))),
...
function hd(e, t) {
  for (let r of t.fields)
    r.isRelation &&
      !e.hasField(r.name) &&
      e.addSuggestion(new de(r.name, "true"));
}
function yd(e, t) {
  for (let r of t.fields)
    !e.hasField(r.name) &&
...
function Ed(e, t) {
  for (let r of t)
    e.hasField(r.name) ||
      e.addSuggestion(new de(r.name, r.typeNames.join(" | ")));
}
function ca(e, t) {
  let [r, n] = lr(e),
...
var Dt = class {
  ...
  json(t) {
    return (
      Ra(this._client), this._client._engine.metrics({ format: "json", ...t })
    );
  }
};
function Sa(e) {
...
var Zi = new WeakMap(),
  ...
  Er = class {
    constructor(t, r) {
      Zi.set(this, { sql: t, values: r }),
        Object.defineProperty(this, kn, { value: kn });
    }
    get sql() {
...
var Ba = (e) => (Array.isArray(e) ? e : e.split(".")),
  ...
  Ua = (e, t, r) =>
    Ba(t).reduceRight(
      (n, i, o, s) => Object.assign({}, no(e, s.slice(0, o)), { [i]: n }),
      r
    );
function tm(e, t) {
...
async function ml(e, t) {
  ...
  if (
    (Cm("enginePath", n), n !== void 0 && e === "binary" && Pi(n), n !== void 0)
  )
...
\`\`\``
      : "",
    c = (0,
    ao.default)(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
async function Nm(e, t) {
  ...
  if (o !== void 0 || n === "0.0.0" || n === "in-memory") {
    ...
    try {
      ...
      throw (
        (console.error("JSON.parse error: body fetched from unpkg.com: ", m), h)
      );
    }
    return g.version;
  }
    ...
    if (!this.engine) {
      ...
      try {
        ...
        throw typeof n == "string"
          ? r
          : new C(n.message, this.config.clientVersion, n.error_code);
      }
    }
  }
  logger(t) {
...
${a.backtrace}`,
  ...
  buildQueryError(t) {
    if (t.user_facing_error.is_panic)
      return new pe(
        xo(this, t.user_facing_error.message),
        this.config.clientVersion
      );
    let r = this.getExternalAdapterError(t.user_facing_error);
    return r
      ? r.error
      : Ft(t, this.config.clientVersion, this.config.activeProvider);
  }
...
var vo =
    ...
    (r) => {
      ...
      if (On(r))
        (n = r.sql),
          (i = { values: Ut(r.values), __prismaRawParameters__: !0 });
...
function cu(e) {
  class t {
    constructor(n) {
      ...
      let a =
        (!s && er(o, { conflictCheck: "none" })) || e.injectableEdgeEnv?.();
      try {
        let l = n ?? {},
          u = l.__internal ?? {},
          c = u.debug === !0;
          ...
          (this._engineConfig = {
            ...
            logQueries:
              ...
              !!(typeof l.log == "string"
                ? l.log === "query"
                : l.log.find((g) =>
                    typeof g == "string" ? g === "query" : g.level === "query"
                  )),
            env: a?.parsed ?? {},
            flags: [],
    ...
    _request(n) {
      ...
      return this._tracingHelper.runInChildSpan(s.operation, () =>
        new au.AsyncResource("prisma-client-request").runInAsyncScope(() =>
          l(o)
        )
      );
    }
