...
h.precision = h.sd = function (e) {
  ...
  return (
    i.d ? ((n = _e(i.d)), e && i.e + 1 > n && (n = i.e + 1)) : (n = NaN), n
  );
};
h.round = function () {
  var e = this,
...
h.toSignificantDigits = h.toSD = function (e, n) {
  ...
  return (
    e === void 0
      ...
      : (A(e, 1, V), n === void 0 ? (n = t.rounding) : A(n, 0, 8)),
    p(new t(i), e, n)
  );
};
h.toString = function () {
...
var k = (function () {
  ...
  return function (t, r, s, o, u, c) {
    ...
    if (
      (S[a] > (O[a] || 0) && l--,
      s == null
        ? ((_ = s = ee.precision), (o = ee.rounding))
        : u
          ? (_ = s + (t.e - r.e) + 1)
          : (_ = s),
      _ < 0)
...
function Se(e, n, i, t) {
  ...
  if (
    (v
      ? (A(i, 1, V), t === void 0 ? (t = g.rounding) : A(t, 0, 8))
...
function $n(e) {
  var n,
    ...
    u = [];
  if (
    (e === void 0 ? (e = this.precision) : A(e, 1, V),
    (t = Math.ceil(e / m)),
    this.crypto)
  )
